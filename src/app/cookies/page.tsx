	...
	return (
		<div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
			<h1 className="text-3xl font-bold mb-8">
				Welcome to Yu-Chun's Smile Cookies Store
			</h1>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mb-30">
				{data.cookies.map((cookie: Cookie) => (
					...
					>
						<div className="w-1/2">
							...
							<p className="text-gray-500 text-sm">Size: {cookie.size}</p>
						</div>
						<div className="w-1/2">
							<img
								src={cookie.imageUrl}
